        ...
        <>
            ...
            >
                ...
                >
                    ...
                    {/* Bot Body */}
                    <div className="relative w-20 h-20 bg-gradient-to-br from-primary-500 to-primary-700 rounded-full shadow-glow flex items-center justify-center">
                        {/* LED Face */}
                        <motion.div
                            key={expression}
                        ...
                        >
                            <div className="bg-accent-500 rounded-lg p-1.5 shadow-glow-accent">
